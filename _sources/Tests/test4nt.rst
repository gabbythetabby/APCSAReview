...
.. mchoice:: qtnt4_18
   ...
   The method ``printNames`` is shown below. ``printNames`` prints out all the Strings in a 2-D array. Which of the following correctly replaces ``/* to be determined */`` to make the method work as intended?
